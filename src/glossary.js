...
export const GLOSSARY = [
  ...
  ['estate', 'preset 6: worktrees, the gap between a working copy and what it claims to be (package.json against the latest tag), and live CPU per project. A SNAPSHOT sampled from the OS at the moment you look, not a record from any transcript -- refreshed while this screen is on, never spent on a preset nobody is looking at.'],
